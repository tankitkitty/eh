...
-- ----------------------------
-- Procedure structure for `epi_notin_cvaccinetype`
-- ----------------------------
DROP PROCEDURE IF EXISTS `epi_notin_cvaccinetype`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `epi_notin_cvaccinetype`()
BEGIN 
...
#############################################################
 ...
 #Routine body goes here...
DROP TABLE IF EXISTS epi_notin_cvaccinetype_t;
CREATE TABLE epi_notin_cvaccinetype_t (
id int(15) NOT NULL AUTO_INCREMENT COMMENT 'ลำดับ',
hospcode varchar(5) NOT NULL DEFAULT '' COMMENT 'รหัสหน่วยบริการ',
hosname varchar(100) NOT NULL DEFAULT '' COMMENT 'ชื่อหน่วยบริการ',
pid VARCHAR(10) NOT NULL DEFAULT '' COMMENT 'ทะเบียนบุคคล',
...
age_y varchar(5) NOT NULL DEFAULT '' COMMENT 'อายุ',
date_serv date COMMENT 'วันที่รับบริการ',
vaccinetype varchar(5) NOT NULL DEFAULT '' COMMENT 'รหัสวัคซีน',
vaccineplace varchar(5) NOT NULL DEFAULT '' COMMENT 'สถานที่รับวัคซีน',

PRIMARY KEY (id)

)ENGINE=MyISAM DEFAULT CHARSET=utf8;

TRUNCATE TABLE epi_notin_cvaccinetype_t;

INSERT INTO epi_notin_cvaccinetype_t
(
hospcode,hosname,pid,cid,fullname,age_y,date_serv,vaccinetype,vaccineplace
)

(

select e.hospcode,c.hosname,e.pid,p.cid,CONCAT(p.`NAME`,' ',p.LNAME)AS fullname,
timestampdiff(year,birth,date_serv) as age_y,e.date_serv,e.vaccinetype,e.vaccineplace 
from hdc.epi e 
left join hdc.person p on p.hospcode=e.hospcode and p.pid=e.pid 
left outer join hdc.chospital c on c.hoscode=e.hospcode 
where e.date_serv  BETWEEN @start_d AND @end_d
and e.vaccinetype not in (select vaccinecode from hdc.cvaccinetype) 
order by e.hospcode,e.PID
...
#################################
 ...
 #Routine body goes here...
DROP TABLE IF EXISTS epi_notin_cvaccinetype_s;
CREATE TABLE epi_notin_cvaccinetype_s (
id int(15) NOT NULL AUTO_INCREMENT COMMENT 'ลำดับ',
hospcode varchar(5) NOT NULL DEFAULT '' COMMENT 'รหัสหน่วยบริการ',
hosname varchar(100) NOT NULL DEFAULT '' COMMENT 'ชื่อหน่วยบริการ',
distcode varchar(15) NOT NULL DEFAULT '' COMMENT 'รหัสอำเภอ',
total_pid VARCHAR(5) NOT NULL DEFAULT '' COMMENT 'จำนวนทั้งหมด',
y_cases VARCHAR(5) NOT NULL DEFAULT '' COMMENT 'จำนวนข้อผิดพลาด',
...
TRUNCATE TABLE epi_notin_cvaccinetype_s;

INSERT INTO epi_notin_cvaccinetype_s
(
hospcode,hosname,distcode,total_pid,y_cases,percent
)
...
left outer join hdc.chospital c on c.hoscode=e.hospcode 
where e.date_serv  BETWEEN @start_d AND @end_d 
GROUP BY e.HOSPCODE) AS nd
LEFT JOIN
(select hospcode,count(pid) as y_cases from epi_notin_cvaccinetype_t
group by hospcode)as st
on nd.hospcode=st.hospcode
LEFT JOIN hdc.chospital h on h.hoscode=nd.hospcode
ORDER BY st.y_cases DESC
...
#################################
 ...
 #Routine body goes here...
DROP TABLE IF EXISTS epi_notin_cvaccinetype_a;
CREATE TABLE epi_notin_cvaccinetype_a (
distcode varchar(15) NOT NULL DEFAULT '' COMMENT ' รหัสอำเภอ',
ampurname varchar(100) NOT NULL DEFAULT '' COMMENT 'ชื่ออำเภอ',
total_pid varchar(15) NOT NULL DEFAULT '' COMMENT 'จำนวนครั้ง',
...
TRUNCATE TABLE epi_notin_cvaccinetype_a;

INSERT INTO epi_notin_cvaccinetype_a
(
distcode,ampurname,total_pid,y_cases,percent
)
...
IFNULL(SUM(s.y_cases),0) AS y_cases,
round((IFNULL(SUM(s.y_cases),0) /SUM(s.total_pid))*100,2) AS percent
FROM epi_notin_cvaccinetype_s s
LEFT JOIN hdc.campur ca ON ca.ampurcodefull = s.distcode AND ca.changwatcode=@province
GROUP BY s.distcode
ORDER BY y_cases DESC
...
-- ----------------------------
-- Procedure structure for `person_deaths`
-- ----------------------------
DROP PROCEDURE IF EXISTS `person_deaths`;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `person_deaths`(IN s_runtime date, IN e_runtime date, IN procedure_name VARCHAR(100))
BEGIN 
IF(s_runtime IS NOT NULL AND  e_runtime IS NOT NULL) THEN
set @start_d := s_runtime; /* วันที่เกิด ของแฟ้ม labor ,วันจำหน่ายของแฟ้ม admission*/
set @end_d := e_runtime;
...
###########################################################################################################################################
#############################################################
DROP TABLE IF EXISTS tmp_person_deaths_t;
CREATE TABLE tmp_person_deaths_t (
id int(15) NOT NULL AUTO_INCREMENT COMMENT 'ลำดับ',
hospcode varchar(5) NOT NULL DEFAULT '' COMMENT 'รหัสหน่วยบริการ',
pid VARCHAR(10) NOT NULL DEFAULT '' COMMENT 'ทะเบียนบุคคล',
fullname VARCHAR(50) NOT NULL DEFAULT '' COMMENT 'ชื่อนามสกุล',
an varchar(10) NOT NULL DEFAULT '' COMMENT 'เลขที่ผู้ป่วยใน',
ddeath date COMMENT 'วันที่ตาย',
CDEATH_A varchar(10) NOT NULL DEFAULT '' COMMENT 'โรคที่เสียชีวิต_a',
CDEATH varchar(10) NOT NULL DEFAULT '' COMMENT 'สาเหตุการตาย',
HOSPDEATH varchar(10) NOT NULL DEFAULT '' COMMENT 'สถานที่เสียชีวิต',

PRIMARY KEY (id)

)ENGINE=MyISAM DEFAULT CHARSET=utf8;

TRUNCATE TABLE tmp_person_deaths_t;

INSERT INTO tmp_person_deaths_t
(
hospcode,pid,fullname,an,ddeath,CDEATH_A,CDEATH,HOSPDEATH
)

( 

SELECT p1.hospcode,p1.pid,concat(p1.`NAME`,' ',p1.lname)AS fullname,d1.AN,d1.ddeath,d1.CDEATH_A,d1.CDEATH,d1.HOSPDEATH 
FROM hdc.person p1
INNER JOIN hdc.death d1 ON d1.pid=p1.pid AND d1.hospcode=p1.HOSPCODE
WHERE d1.ddeath BETWEEN @start_d AND @end_d
ORDER BY p1.HOSPCODE,p1.PID,d1.DDEATH
...
#############################################################
 ...
 #Routine body goes here...
DROP TABLE IF EXISTS person_deaths_t;
CREATE TABLE person_deaths_t (
id int(15) NOT NULL AUTO_INCREMENT COMMENT 'ลำดับ',
hospcode varchar(5) NOT NULL DEFAULT '' COMMENT 'รหัสหน่วยบริการ',
pid VARCHAR(10) NOT NULL DEFAULT '' COMMENT 'ทะเบียนบุคคล',
fullname VARCHAR(50) NOT NULL DEFAULT '' COMMENT 'ชื่อนามสกุล',
...
pid2 VARCHAR(10) NOT NULL DEFAULT '' COMMENT 'ทะเบียนบุคคล2',
fullname2 VARCHAR(50) NOT NULL DEFAULT '' COMMENT 'ชื่อนามสกุล2',
an2 varchar(10) NOT NULL DEFAULT '' COMMENT 'เลขที่ผู้ป่วยใน2',
ddeath2 date COMMENT 'วันที่ตาย2',
CDEATH_A2 varchar(10) NOT NULL DEFAULT '' COMMENT 'โรคที่เสียชีวิต_a2',
CDEATH2 varchar(10) NOT NULL DEFAULT '' COMMENT 'สาเหตุการตาย2',
HOSPDEATH2 varchar(10) NOT NULL DEFAULT '' COMMENT 'สถานที่เสียชีวิต2',

PRIMARY KEY (id)

)ENGINE=MyISAM DEFAULT CHARSET=utf8;

TRUNCATE TABLE person_deaths_t;

INSERT INTO person_deaths_t
(
hospcode,pid,fullname,an,ddeath,CDEATH_A,CDEATH,HOSPDEATH,hospcode2,pid2,fullname2,an2,ddeath2,CDEATH_A2,CDEATH2,HOSPDEATH2
)

( 
SELECT  p1.hospcode,p1.pid,concat(p1.`NAME`,' ',p1.lname)AS fullname1,d1.AN,d1.ddeath,d1.CDEATH_A,d1.CDEATH,d1.HOSPDEATH,
p2.hospcode,p2.pid,concat(p2.`NAME`,' ',p2.lname)AS fullname2,d2.AN,d2.ddeath,d2.CDEATH_A,d2.cdeath,d2.HOSPDEATH
FROM hdc.person p1
INNER JOIN hdc.person p2 ON p1.cid=p2.cid AND p1.hospcode<> p2.hospcode 
INNER JOIN hdc.death d1 ON d1.pid=p1.pid AND d1.hospcode=p1.HOSPCODE
INNER JOIN hdc.death d2 ON d2.pid=p2.pid AND d2.hospcode=p2.HOSPCODE
...
#################################
 ...
 #Routine body goes here...
DROP TABLE IF EXISTS person_deaths_s;
CREATE TABLE person_deaths_s (
id int(15) NOT NULL AUTO_INCREMENT COMMENT 'ลำดับ',
hospcode varchar(5) NOT NULL DEFAULT '' COMMENT 'รหัสหน่วยบริการ',
hosname varchar(100) NOT NULL DEFAULT '' COMMENT 'ชื่อหน่วยบริการ',
distcode varchar(15) NOT NULL DEFAULT '' COMMENT 'รหัสอำเภอ',
...
TRUNCATE TABLE person_deaths_s;

INSERT INTO person_deaths_s
(
hospcode,hosname,distcode,total_pid,y_cases,percent
)
...
GROUP BY HOSPCODE) AS nd
LEFT JOIN
(select hospcode,count(pid) as y_cases from person_deaths_t
group by hospcode)as st
on nd.hospcode=st.hospcode
LEFT JOIN hdc.chospital h on h.hoscode=nd.hospcode
ORDER BY st.y_cases DESC
...
#################################
 ...
 #Routine body goes here...
DROP TABLE IF EXISTS person_deaths_a;
CREATE TABLE person_deaths_a (
distcode varchar(15) NOT NULL DEFAULT '' COMMENT ' รหัสอำเภอ',
ampurname varchar(100) NOT NULL DEFAULT '' COMMENT 'ชื่ออำเภอ',
total_pid varchar(15) NOT NULL DEFAULT '' COMMENT 'จำนวนครั้ง',
y_cases VARCHAR(10) NOT NULL DEFAULT '' COMMENT 'จำนวนข้อผิดพลาด',
...
TRUNCATE TABLE person_deaths_a;

INSERT INTO person_deaths_a
(
distcode,ampurname,total_pid,y_cases,percent
)
...
-- ----------------------------
ALTER TABLE `sys_report` AUTO_INCREMENT=10078;
