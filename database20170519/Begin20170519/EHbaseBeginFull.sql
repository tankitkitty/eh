...
-- ----------------------------
BEGIN;
INSERT INTO `auth_item_child` VALUES ('ADMIN', '/*'), ('admin_cup', '/report/report/calldocs'), ('pcu', '/report/report/calldocs'), ('admin_cup', '/report/report/chk'), ('pcu', '/report/report/chk'), ('admin_cup', '/report/report/index'), ('pcu', '/report/report/index'), ('admin_cup', '/report/report/runreport2'), ('pcu', '/report/report/runreport3'), ('ผู้ดูแลระบบ', '/user/*'), ('admin_cup', '/user/security/login'), ('pcu', '/user/security/login'), ('admin_cup', '/user/security/logout'), ('pcu', '/user/security/logout'), ('ผู้ดูแลระบบ', 'ADMIN'), ('ผู้ดูแลระบบระดับ cup', 'admin_cup'), ('หน่วยบริการ', 'pcu');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `diag_no_price` VALUES ('Z001', 'การตรวจสุขภาพเด็กตามปกติ'), ('Z131', 'การตรวจคัดกรองพิเศษสำหรับเบาหวาน'), ('Z138', 'การตรวจคัดกรองพิเศษสำหรับโรคและความผิดปกติอื่นที่ระบุรายละเอียด'), ('Z713', 'การให้คำปรึกษาและการเฝ้าระวังด้านอาหาร'), ('Z133', 'การตรวจคัดกรองพิเศษสำหรับความผิดปกติทางจิตและพฤติกรรม'), ('Z123', 'การตรวจมะเร็งเต้านม'), ('Z124', 'การตรวจมะเร็งปากมดลูก'), ('Z013', 'การตรวจความดันโลหิต'), ('Z011', 'การตรวจหูและการได้ยิน'), ('Z012', 'การตรวจทางทันตกรรม'), ('Z010', 'การตรวจตาและการมองเห็น'), ('Z014', 'การตรวจทางนรีเวชวิทยา(ทั่วไป)'), ('Z108', 'ตรวจสุขภาพนักเรียน');
COMMIT;
...
bhosp VARCHAR(10) NOT NULL DEFAULT '' COMMENT 'สถานบิรการที่คลอด Labor',
...
birth varchar(15) NOT NULL DEFAULT '' COMMENT 'วันเกิด',
date_serv date COMMENT 'วันที่รับบริการ',
...
(SELECT l.HOSPCODE, ch.hosname,l.PID,concat(p.`NAME`,' ',p.LNAME)as fullname,lt.LABTEST,l.DATE_SERV,l.LABRESULT,c.CHRONIC 
FROM hdc.labfu l 
...
y_cases VARCHAR(5) NOT NULL DEFAULT '' COMMENT 'มากกว่า17',
percent VARCHAR(5) NOT NULl DEFAULT '' COMMENT 'ร้อยละ',
...
LEFT JOIN hdc.chospital ch ON ch.hoscode = l.HOSPCODE 
WHERE l.date_serv BETWEEN @start_d AND @end_d and l.labtest in ('11',' 0581803') AND l.labresult NOT BETWEEN '0.01' AND '25' 
GROUP BY l.HOSPCODE,l.pid )as st on nd.hospcode=st.hospcode 
...
y_cases VARCHAR(5) NOT NULL DEFAULT '' COMMENT 'น้อยกว่า 4 หรือมากกว่า14',
percent VARCHAR(5) NOT NULl DEFAULT '' COMMENT 'ร้อยละ',
...
newborn_bdate date COMMENT 'วันที่คลอด Newborn',
PRIMARY KEY (id)
...
typearea varchar(2) NOT NULL DEFAULT '' COMMENT 'สถานะ',
...
bresult VARCHAR(10) NOT NULL DEFAULT '' COMMENT 'ผลครรภ์',
bhosp VARCHAR(10) NOT NULL DEFAULT '' COMMENT 'สถานที่คลอด',
...
hn VARCHAR(15) NOT NULL DEFAULT '' COMMENT 'HN',
bdate date COMMENT 'วันคลอด',
bresult VARCHAR(6) NOT NULL DEFAULT '' COMMENT 'ผลคลอด',
...
LEFT JOIN hdc.person p on ch.HOSPCODE=p.HOSPCODE and ch.PID=p.PID
inner join hdc.chospital c on c.hoscode=ch.HOSPCODE
WHERE (sbp_1-dbp_1 <15 or sbp_1-dbp_1 > 105  or sbp_2-dbp_2 <15 or sbp_2-dbp_2 > 105 )
AND ch.date_serv BETWEEN @start_d AND @end_d
...
FROM hdc.ncdscreen ch
join hdc.chospital c on c.hoscode=ch.HOSPCODE
WHERE (sbp_1-dbp_1 <20 or sbp_1-dbp_1 > 80 or sbp_1<dbp_1 or sbp_2<dbp_2 or sbp_2-dbp_2 <20 or sbp_2-dbp_2 > 80 )
and ch.date_serv BETWEEN @start_d AND @end_d 
group by c.distcode
)as st 
on nd.distcode=st.distcode
...
pid varchar(15) NOT NULL DEFAULT '' COMMENT 'ทะเบียนบุคคล',
fullname varchar(100) NOT NULL DEFAULT '' COMMENT 'ชื่อ-สกุล',
TYPEAREA varchar(1) NOT NULL DEFAULT '' COMMENT 'สถานะอยู่อาศัย',
...
lname VARCHAR(50) NOT NULL DEFAULT '' COMMENT 'นามสกุล',
nation varchar(5) NOT NULL DEFAULT '' COMMENT 'สัญชาติ',
typearea varchar(5) NOT NULL DEFAULT '' COMMENT 'สถานะบุคคล',
discharge varchar(1) NOT NULL DEFAULT '' COMMENT 'สถานะการจำหน่าย',
d_update varchar(15) NOT NULL DEFAULT '' COMMENT 'วันเดือนปีที่ปรับปรุงข้อมูล',
...
-- ----------------------------
ALTER TABLE `sys_report` AUTO_INCREMENT=10069;
